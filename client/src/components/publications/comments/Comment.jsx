            ...
            <div className='flex mt-3 p-2 border border-slate-100 rounded-sm shadow-md'>
                ...
                <div className="w-full px-5">
                    <div className='flex justify-between'>
                        <span className="font-bold text-slate-800 text-sm">{capitalize(comment.author.name)} {capitalize(comment.author.surname)}</span>
                        <span className='text-slate-600 text-xs'>{tiempoTranscurrido}</span>
                    </div>
